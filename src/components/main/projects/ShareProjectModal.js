...
const ShareProjectModal = withRedux(
    ({
        ...
        const [shareProject, { loadingShareProject }] = useMutation(
            gql`
        ...
        return (
            <Modal
                ...
                size="small"
                trigger={
                    <Button color="twitter" animated="vertical">
                ...
                <Modal.Content>
                    <Segment attached="top">
                        <Header
                            icon="add user"
                            content={projectName}
                            subheader="Share this project with other users?"
                        />
                    </Segment>
