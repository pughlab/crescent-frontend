...
import { Container, Card, Divider, Button, Header, Icon, Segment } from "semantic-ui-react";
...
const RunsCardList = withRedux(
    ({
        ...
        const projectRuns = R.ifElse(queryIsNotNil("runs"), R.prop("runs"), R.always([]))(data);
        console.log(data);
        return (
            <Container>
