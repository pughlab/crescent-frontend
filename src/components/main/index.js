    ...
    ({
        ...
        return (
            <Segment
                basic
                attached="bottom"
                style={{ minHeight: "calc(100vh - 5rem - 2px)", marginTop: 0, backgroundImage: `url(${memphisMini})` }}
                as={Grid}
            >
                {R.cond([
                    [R.equals("login"), R.always(<LandingPageComponent />)],
                    [
                        R.equals("projects"),
                        R.always(
                    ...
                    [R.equals("vis"), R.always(<VisComponent />)]
                ])(mainView)}
            </Segment>
        );
    }
