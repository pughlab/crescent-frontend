      ...
      parameters: [
        {
          ...
          input: {
            ...
            defaultValue: 'sc',
            options: [
              {key: 'log_normalize', value: 'log', text: 'LogNormalize'},
              {key: 'sc_transform', value: 'sc', text: 'SCTransform'},
              {key: 'skip_normalization', value: 'skip', text: 'Skip Normalization (input already normalized)'},
            ]
          },
          disabled: false
        }
