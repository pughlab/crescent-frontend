...
if (regexpr("^Y$", RunsCwl, ignore.case = T)[1] == 1) {
  ...
  interactive_qc_plot_u$Mitochondrial_Genes_Fraction <- interactive_qc_plot_u$Mitochondrial_Genes_Fraction * 100
  interactive_qc_plot_u$Ribosomal_Protein_Genes_Fraction <- interactive_qc_plot_u$Ribosomal_Protein_Genes_Fraction * 100
  ...
  interactive_qc_plot_f$Mitochondrial_Genes_Fraction <- interactive_qc_plot_f$Mitochondrial_Genes_Fraction * 100
  interactive_qc_plot_f$Ribosomal_Protein_Genes_Fraction <- interactive_qc_plot_f$Ribosomal_Protein_Genes_Fraction * 100
  ...
  qc_tsv$Mitochondrial_Genes_Fraction <- qc_tsv$Mitochondrial_Genes_Fraction * 100
  qc_tsv$Ribosomal_Protein_Genes_Fraction <- qc_tsv$Ribosomal_Protein_Genes_Fraction * 100
...
###############################################################
### PUGHLAB/CRESCENT/RUNS_SEURAT_V3 GITHUB VERSION d6c6d72 ###
##############################################################