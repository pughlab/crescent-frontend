...
const PortalInfo = () => (
  ...
  <Segment.Group>
    ...
    <Segment>
      ...
      To reach the crescent.cloud portal-dev team, please email <a href='mailto:crescent@uhnresearch.ca'>crescent@uhnresearch.ca</a> using these template forms to: <a href='https://github.com/pughlab/crescent/blob/master/.github/ISSUE_TEMPLATE/bug_report.md' target='_blank' rel="noopener noreferrer">report bugs</a> or <a href='https://github.com/pughlab/crescent/blob/master/.github/ISSUE_TEMPLATE/feature_request.md' target='_blank' rel="noopener noreferrer">request features.</a> This can also be done on our <a href='https://github.com/pughlab/crescent' target='_blank' rel="noopener noreferrer">Github.</a>
    </Segment>
